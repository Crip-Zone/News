	...
	if ($context['user']['is_logged'])
		echo '
						<ul class="unread_links">
							<li>
								<a href="', $scripturl, '?action=unread" title="', $txt['view_unread_category'], '">',$txt['unread_since_visit'], '</a>
							</li>
							<li>
								<a href="', $scripturl, '?action=unreadreplies" title="', $txt['unread_replies'], '">', $txt['show_unread_replies'], '</a>
							</li>
						</ul>';
...
function template_body_below()
{
	...
	echo '
		<ul>
			...
			<li class="copyright">News by, <a href="http://www.jpr62.com/theme/index.php" title="Akyhne">Akyhne</a> - Updated to SMF 2.1 By <a href="http://www.jpr62.com/theme/index.php" title="TheCripZone">TheCripZone</a></li>
		</ul>';
